...
# 2. Título e Introdução do Dashboard
...
# 3. Seleção das variáveis (features) e variável-alvo
...
# 5. Avaliação do Modelo com Métricas de Regressão
...
# 6. Sugestão automática de manejo agrícola baseada na previsão média
...
# 7. Visualização aprimorada: Histograma real com Matplotlib
...
# 8. Visualização: Tabela de correlações das features com a variável alvo
...
# 9. Simulador de Cenários com comentários didáticos
st.divider()
...
# 10. Finalização didática do painel
st.divider()
st.markdown("""
